...
const NewSafetyAudit2: React.FC = () => {
  return (
    <div className="py-6 space-y-6">
      {/* Project Information */}
      <Card title="Project Information" headerColor="bg-gradient-to-r from-[#a90e2c] to-[#a90e2c] text-white rounded-t-md">
      ...
      {/* Audit Summary */}
      <Card title="Audit Summary" headerColor="bg-gradient-to-r from-[#a90e2c] to-[#a90e2c] text-white rounded-t-md">
      ...
      {/* Severity Levels */}
      <Card title="Severity Levels" headerColor="bg-gradient-to-r from-[#a90e2c] to-[#a90e2c] text-white rounded-t-md">
      ...
      <Card title="Audit Categories" headerColor="bg-gradient-to-r from-[#a90e2c] to-[#a90e2c] text-white rounded-t-md">
        <div className="mb-6">
